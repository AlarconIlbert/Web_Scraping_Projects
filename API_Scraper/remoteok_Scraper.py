...
if __name__ == '__main__':
    ...
    output_jobs_to_xlsx(json)
    send_email('ilbertalarcon1@gmail.com', ['ilbertalarcon1@gmail.com'], 'Jobs Posting', 'Please, find the attach a list of job posting to this email', files=['remote_jobs.xls'])